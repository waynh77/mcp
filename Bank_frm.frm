   ...
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "Bank_frm.frx":3496
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "Bank_frm.frx":4E28
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "Bank_frm.frx":67BA
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "Bank_frm.frx":814C
            Key             =   ""
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "Bank_frm.frx":9ADE
            Key             =   ""
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "Bank_frm.frx":B470
            Key             =   ""
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "Bank_frm.frx":C14A
            Key             =   ""
         EndProperty
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "Bank_frm.frx":CE24
            Key             =   ""
         EndProperty
      EndProperty
   End
...
Sub isi_grid()
If Label3 = "TRANSAKSI BANK MASUK" Then
    Data1.RecordSource = "select * from rekap_jurnal where cdate(tgl)='" & DTPicker1 & "' and no_akun <> '1-120' and sumber_akun='1-120'and dk='KREDIT'"
Else
    Data1.RecordSource = "select * from rekap_jurnal where cdate(tgl)='" & DTPicker1 & "' and no_akun <> '1-120' and sumber_akun='1-120' and dk='DEBET'"
End If
Data1.Refresh
hit_trans
Isi
...
Tutup
DTPicker1 = Date
Label3.Caption = "TRANSAKSI BANK MASUK"
End Sub
...
Case 2
    If Toolbar1.Buttons(2).Caption = "Edit" Then
        Buka
        tambah = False
        keter = "1-120" & DTPicker1 & Text2(5) & Text2(3)
...
Else
    With Data1.Recordset
        If tambah = True Then
            ...
            !ket = Text2(3)
            !jml = Text2(4)
            If Label3.Caption = "TRANSAKSI BANK MASUK" Then
                !dk = "KREDIT"
            Else
                !dk = "DEBET"
            End If
...
With Data1.Recordset
    ...
    !ket = Text2(3)
    !jml = Text2(4)
    If Label3.Caption = "TRANSAKSI BANK KELUAR" Then
        !dk = "KREDIT"
    Else
        !dk = "DEBET"
    End If
...
Dim sal As Double
Dim dk As String
Data3.RecordSource = "select * from bukubesar where no_akun='1-120' order by tgl desc,jam desc"
Data3.Refresh
With Data3.Recordset
    .MoveFirst
    sal = !saldo
...
With Data3.Recordset
    ...
    With Data2.Recordset
        ...
        End If
    End With
    If Label3.Caption = "TRANSAKSI BANK MASUK" And dk = "DEBET" Then
        !saldo = sal - Val(Format(Text2(4), "###"))
    Else
        !saldo = sal + Val(Format(Text2(4), "###"))
    End If
